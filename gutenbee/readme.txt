...
= 2.20.3 =
* Fixed a minor issue where images would overflow their container in some cases.

= 2.20.2 =
* Remove JSON upload whitelisting (leftover from experimental Lottie support). Fixes CVE-2026-9227 (props Athiwat Tiprasaharn (Jitlada))
